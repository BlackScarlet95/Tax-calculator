...
#To catch and handle possible error
try:
    ...
    #Head of Household        
        ...
        if income <= 11950:
            ...
            tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45550) * 0.25 + (190200 - 117450) * 0.28 + (income - 190200) * 0.33
        else:
    ...
    #Corrects to two decimal places and seperates thousands eith commas
